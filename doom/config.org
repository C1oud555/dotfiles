...
** Font Sets
#+begin_src emacs-lisp
(setq! doom-font (font-spec :family "Monaco" :size 16 :weight 'normal :width 'normal)
       doom-variable-pitch-font (font-spec :family "Monaco" :size 16 :weight 'normal :width 'normal)
...
** LSP
#+begin_src emacs-lisp
(add-hook! lsp-mode-hook (map! :leader
                               :desc "lsp-avy-lens"
                               "c l l" #'lsp-avy-lens))
#+end_src
*** verilog
