...
#+begin_src emacs-lisp
(setq!
 doom-font (font-spec :family "Monaco" :size 15 :weight 'normal :width 'normal)
 doom-variable-pitch-font (font-spec :family "Monaco" :size 17 :weight 'normal :width 'normal)
 doom-big-font (font-spec :family "Monaco" :size 23))

(defun init-cjk-fonts()
  (dolist (charset '(kana han cjk-misc bopomofo))
    (set-fontset-font (frame-parameter nil 'font)
      charset (font-spec :family "HiraginoSansGB-W3" :size 15))))
...
** Org-Download
#+begin_src emacs-lisp
(setq! org-download-image-dir (expand-file-name "images" org-directory)) ;; to get around of doom config
(after! org-download
...
#+begin_src emacs-lisp
(after! pyim
  (map! "M-q" #'pyim-convert-string-at-point)
  (setq!
   pyim-dicts '((:name "tsinghua" :file "~/.config/emacs/.local/cache/pyim-dict/pyim-tsinghua-dict.pyim"))
  ...
  (setq-default pyim-punctuation-half-width-functions
                '(pyim-probe-punctuation-line-begining
...
#+end_src
** Orderless + pinyin
在doom:chinese 中已经有了对应的实现
#+begin_src emacs-lisp
;; (after! orderless
;;   (defun my-orderless-regexp (orig-func component)
;;     (let ((result (funcall org-func component)))
;;       (pyim-cregexp-build result)))
;;   (advice-add 'orderless-regexp :round #'my-orderless-regexp)
#+end_src
* Consult
#+begin_src emacs-lisp
(after! consult
